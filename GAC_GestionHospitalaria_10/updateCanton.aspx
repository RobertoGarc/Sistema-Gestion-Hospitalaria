<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="updateCanton.aspx.cs" Inherits="GAC_GestionHospitalaria_10.updateCanton" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

 <div>
        <h2>Actualizar Cantones </h2>
    </div>
    <div class ="row" >
        <div class="p-1" >
