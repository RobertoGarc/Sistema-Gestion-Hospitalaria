<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="newProvincias.aspx.cs" Inherits="GAC_GestionHospitalaria_10.newProvincias" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">


    <div>
        <h2>Ingreso de Provincias </h2>
    </div>
    <div class ="row" >
        <div class="p-1" >
