<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SerchParroquia.aspx.cs" Inherits="GAC_GestionHospitalaria_10.SerchParroquia" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <div>
            <h2> Administrar Parroquia </h2>
            <p>&nbsp;</p>
        </div>
       <div>
           <table style="width:100%;">
               ...
               <tr>
                ...
                <tr>
                   <td style="width: 60px">&nbsp;</td>
                   <td>
                       <asp:UpdatePanel ID="udp_Parroquia" runat="server">
                           <ContentTemplate>
                               <asp:GridView ID="gv_Parroquia" runat="server" AutoGenerateColumns="False" OnRowCommand="gv_Parroquia_RowCommand" CellPadding="4" ForeColor="#333333" GridLines="None"  >
                                   <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                   <Columns>
                                       <asp:BoundField DataField="Id_parroquia" HeaderText="Id_Parroquia" />
                                       <asp:BoundField DataField="Parroquia" HeaderText="Parroquia" />
                                       <asp:BoundField DataField="Id_canton" HeaderText="Id_Canton" />
                                       <asp:BoundField DataField="Numhabitantes" HeaderText="Habitantes" />
