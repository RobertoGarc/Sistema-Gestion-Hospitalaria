<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="newHospitales.aspx.cs" Inherits="GAC_GestionHospitalaria_10.newHospitales" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   
    <div>
        <h2>Ingreso de Hospitales </h2>
    </div>
    <div class ="row" >
        <div class="p-1" >
       ...
       <div class ="row">
        <div class="p-1">
            <div class="btn-group" role ="group" aria-level =""> 
                <asp:Button ID="btn_guardar" runat="server" Text="Guadar" OnClick="btn_Guardar_Click" CssClass="btn btn-info"/>
