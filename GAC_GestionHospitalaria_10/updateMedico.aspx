<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="updateMedico.aspx.cs" Inherits="GAC_GestionHospitalaria_10.updateMedico" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <div>
        <h2>Actualizar Medicos </h2>
    </div>
    <div class ="row" >
        <div class="p-1" >
