<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SerchCita.aspx.cs" Inherits="GAC_GestionHospitalaria_10.SerchCita" %>
           ...
           <table style="width:100%;">
               ...
               <tr>
                ...
                <tr>
                   <td style="width: 60px">&nbsp;</td>
                   <td>
                       <asp:UpdatePanel ID="udp_Citas" runat="server">
                           <ContentTemplate>
                               <asp:GridView ID="gv_Citas" runat="server" AutoGenerateColumns="False" OnRowCommand="gv_Citas_RowCommand" CellPadding="4" ForeColor="Black" GridLines="Vertical" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px"  >
