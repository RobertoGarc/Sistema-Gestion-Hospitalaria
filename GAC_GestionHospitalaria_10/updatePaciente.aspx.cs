    ...
    public partial class updatePaciente : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                GAC_Pacientes_10_Logica datos4 = new GAC_Pacientes_10_Logica();
                PACIENTES registro_paciente = new PACIENTES();
                registro_paciente = datos4.get_Registro_Paciente(idpaciente);

                txt_Id_Paciente.Text = registro_paciente.Id_paciente.ToString();
                txt_Nombre1.Text = registro_paciente.Nombre1.ToString();
                txt_Cedula.Text = registro_paciente.Cedula.ToString();
                txt_Nombre2.Text = registro_paciente.Nombre2.ToString();
                txt_Apellido1.Text = registro_paciente.Apellido1.ToString();
                txt_Apellido2.Text = registro_paciente.Apellido2.ToString();
                ddl_TipoSangre.SelectedValue = registro_paciente.ToString();
                txt_Fecha_Nacimiento.Text = registro_paciente.FechaNacimiento.ToString();
                ddl_Sexo.SelectedValue = registro_paciente.ToString();
                ddl_Condicion.SelectedValue = registro_paciente.ToString();
                txt_Direccion.Text = registro_paciente.Direccion.ToString();
                txt_Telefonop.Text = registro_paciente.TelefonoP.ToString();
                txt_Email.Text = registro_paciente.Email.ToString();
                txt_FamiliarContacto.Text = registro_paciente.FamliarContacto.ToString();
                txt_TelefonoC.Text = registro_paciente.TelefonoC.ToString();
                ddl_Parentescos.SelectedValue = registro_paciente.ToString();
            }
        }
        ...
        protected void btn_Guardar_Click(object sender, EventArgs e)
        {
            ...
            nuevoPaciente.Id_paciente = Convert.ToInt32(txt_Id_Paciente.Text);
            ...
            datos.updatePaciente(nuevoPaciente);
        }

        protected void btn_Salir_Click(object sender, EventArgs e)
        {
            Response.Redirect("SerchPaciente.aspx");
        }
